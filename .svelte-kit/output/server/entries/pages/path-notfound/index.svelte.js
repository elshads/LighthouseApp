import { c as create_ssr_component, a as compute_rest_props, b as spread, f as escape_attribute_value, e as escape_object, h as subscribe, l as set_store_value, v as validate_component } from "../../../chunks/index-167532fe.js";
...
const DoNot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let labelled;
  let attributes;
...
const Path_notfound = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="${"py-2"}">${validate_component(DoNot$1, "DoNot").$$render($$result, { class: "error-badge" }, {}, {})}</div>
<div class="${"py-4"}"><div>Page not found</div></div>
<div class="${"py-4"}">Go to ${validate_component(Link, "Link").$$render($$result, { href: "/" }, {}, {
      default: () => {
        return `Homepage`;
      }
    })}</div>
...
export { Path_notfound as default };
